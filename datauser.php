...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <table class="table table-bordered">
            ...
            <?php
            include "koneksi.php";
            $query_mysql = mysqli_query($koneksi, "SELECT * FROM tabel_user") or die(mysqli_error($koneksi));
            $nomor = 1;
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-warning" href="hapususer.php?id=<?php echo $data['id_user']; ?>">Hapus</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
