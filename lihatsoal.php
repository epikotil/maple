...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-body">
            ...
            <!-- Header-->
            <a class="btn btn-primary" href="inputsoal.php">Tambah Soal</a>
            <table class="table table-bordered">
                ...
                <?php
                include "koneksi.php";
                $query_mysql = mysqli_query($koneksi, "SELECT * FROM tabel_soal") or die(mysqli_error($koneksi));
                $nomor = 1;
                ...
                <tr>
                    ...
                    <td><?php echo $data['pilihan_a']; ?></td>
                    <td><?php echo $data['pilihan_b']; ?></td>
                    <td><?php echo $data['pilihan_c']; ?></td>
                    <td><?php echo $data['pilihan_d']; ?></td>
                    <td><?php echo $data['jawaban']; ?></td>
                    <td>
                        <a class="btn btn-warning" href="hapussoal.php?id=<?php echo $data['id_soal']; ?>">Hapus</a>
                        <a class="btn btn-info" href="editsoal.php?id=<?php echo $data['id_soal']; ?>">Edit</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </table>
